...
app.get('/api/leaderboard', async (req, res) => {
  try {
    ...
    // DuckDB can return BigInt-typed values (e.g. timestamps), which
    // JSON.stringify can't serialize directly — convert them to plain values.
